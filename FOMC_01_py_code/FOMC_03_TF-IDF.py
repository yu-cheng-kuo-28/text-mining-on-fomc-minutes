...
for j in range(0,222):
    FOMC_pickle_all = FOMC_pickle_all + FOMC_pickle[j]

print(len(FOMC_pickle[0]))
print(len(FOMC_pickle_all))

FOMC_pickle_all_string = ' '.join(FOMC_pickle_all)
FOMC_pickle_all_string[0:100]

import re
r1 = re.findall('unem[a-z]*', FOMC_pickle_all_string)
print(r1)

r2 = re.match('unem$', FOMC_pickle_all_string)
print(r2)

r3 = re.match('unemp', FOMC_pickle_all_string)
print(r3)

r4 = re.findall('ployment', FOMC_pickle_all_string)
print(r4)

r5 = re.findall('fed', FOMC_pickle_all_string)
print(r5)
